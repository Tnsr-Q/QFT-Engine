...
---
## Architecture
text Inputs ├── runtime configs ├── tolerance priors ├── commands / scripts └── initial solver state │ ▼ Validation & preprocessing │ ▼ Core solver layer ├── RGE ├── flow ├── spectral ├── bootstrap ├── Regge └── Hessian / optimization │ ▼ Governance layer ├── schema enforcement ├── mesh coordination └── tolerance control │ ▼ Outputs ├── logs and diagnostics ├── checkpoints ├── serialized artifacts └── test / report outputs 
---
